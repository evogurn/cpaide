...
const OtpVerification = ({ email, verificationToken, userType, onBack }) => {
  ...
  useEffect(() => {
    let interval = null;
    if (pendingApproval && redirectTimer > 0) {
      interval = setInterval(() => {
        setRedirectTimer(prev => prev - 1);
      }, 1000);
    } else if (pendingApproval && redirectTimer === 0) {
  ...
  }, [pendingApproval, redirectTimer, navigate]);
  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        if (result.data.user?.tenant?.approvalStatus === 'PENDING') {
          setSuccess(false);
          setPendingApproval(true);
          // Don't log in, show pending approval page
          return;
        }
      ...
      <div className="min-h-screen flex flex-col lg:flex-row bg-gray-50 dark:bg-dark-bg-primary">
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-6">
          <div className="w-full max-w-md">
            ...
            {/* Success Message */}
            <div className="bg-white dark:bg-dark-bg-secondary rounded-xl shadow-lg p-8 text-center">
              ...
              <p className="text-gray-600 dark:text-dark-text-secondary mb-6">
                Wait for the Cpaide Admin to approve your account
              </p>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div className="text-sm">
                  <span className={`font-medium ${timer > 0 ? 'text-gray-500 dark:text-dark-text-secondary' : 'text-gray-400'}`}>
