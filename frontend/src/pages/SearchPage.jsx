...
const SearchPage = () => {
  ...
  // Mobile state for showing results panel
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="md:hidden">
        ...
        <div className="overflow-y-auto p-4">
          {!showResults ? (
            // Search inputs (either AI or File)
        ...
        {/* Show Results Button (when results exist) */}
        {((activeTab === 'ai' && aiSearchResults.length > 0) || (activeTab === 'file' && fileSearchResults.length > 0)) && !showResults && (
          <div className="fixed bottom-4 left-4 right-4">
            <button
              onClick={() => setShowResults(true)}
              className="w-full py-3 px-4 bg-accent text-accent-contrast rounded-lg shadow-lg font-medium hover:bg-accent-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-accent"
            >
              Show {activeTab === 'ai' ? 'AI Search' : 'File Search'} Results
            </button>
          </div>
        )}
      </div>
      ...
      <div className="hidden md:flex flex-1 overflow-hidden bg-white rounded-lg shadow dark:bg-dark-bg-secondary">
